...
def init_db():
    ...
    """)
    print('Tables users,courses created')
    # Insert sample data if tables are empty
    cursor.execute("SELECT COUNT(*) FROM users")
    #print('Secelt count of users' + str(cursor.fetchone()[0]))
    if cursor.fetchone()[0] == 0:
        ...
        #cursor.execute("SELECT COUNT(*) FROM users")
        print('Select count after inserting of users' + str(sample_professionals))   
        sample_courses = [
        ...
        print('Select count after inserting of courses' + str(sample_courses))
    ...
    if cursor.fetchone()[0] == 0:
        ...
        """, free_courses)
        print('Select count after inserting of free_courses' + str(free_courses))
    conn.commit()
    conn.close()
